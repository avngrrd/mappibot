...
Потрібен VPS з IPv4, SSH-доступом і 1–2 ГБ RAM. Ця інструкція призначена для нового сервера; її ще не виконано на VPS. Бот використовує long polling, тому домен, HTTPS-сертифікат і вхідні вебпорти не потрібні.
